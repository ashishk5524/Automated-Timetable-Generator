...
<a href="logout.php"><font color="#FFFFFF">Logout</font></a></span>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav" style="background-color:#8A2BE2">

                    <li>
                        <a href="admindashboard.php?info=course" style="color:#FFFFFF"><i class="fa fa-fw fa-dashboard"></i>Department</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=semester" style="color:#FFFFFF"><i class="fa fa-fw fa-bar-chart-o"></i>Semester</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=subject" style="color:#FFFFFF"><i class="fa fa-fw fa-table"></i>Subject</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=student" style="color:#FFFFFF"><i class="fa fa-fw fa-edit"></i>Student</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=teacher" style="color:#FFFFFF"><i class="fa fa-fw fa-desktop"></i>Teacher</a>
                    </li>
                    
                    <li>
                        <a href="admindashboard.php?info=timetable" style="color:#FFFFFF"><i class="fa fa-fw fa-wrench"></i>Time Table</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12" style="background-color:#8A2BE2;height:1000px; width:1100px;"  align="center" margin-top="20px">
				...
				?>
                   ...
                   <font color="#FFFFFF" size="+3" face="Lucida Console, Monaco, monospace">Admin Panel</font><br/>
                    ...
                    <img src="img/online_practice.jpg" class="img-responsive" alt="Cinque Terre" width="500" height="500" style="                          margin-top: 70px; margin-left: 23px;">
                <?php }?>
