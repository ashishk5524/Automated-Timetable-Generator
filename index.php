...
<script src="js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand"><font color="white">Time Table Generator</font></a>
...
<header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="color:red;">Time Table Generator</h1>
                <hr>
...
In every obligation class the condition as determined in our inquiry is now checked between two timetable objects. On the off chance that condition is fulfilled i.e there is a crash is available then the score is augmented by one.</p>
       ...
       <!--contact-->
            ...
            <div class="panel panel-warning" style="padding:10px 25px;background-color: #87CEEB">
...
<!-- <div class="panel panel-warning bg-primary" style="padding:10px 25px;"> -->
  ...
  <div class="panel panel-warning" style="padding:10px 25px;background: #87CEEB">
...
<?php echo @$err; ?>
 ...
 <div class="row" style="margin-bottom: 10px;">
  ...
  <p align="center">Developed By:Santosh Selokar</p>
</footer>--->
           </div>
        </div>
