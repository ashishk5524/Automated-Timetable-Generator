...
<div class="col-md-5"> 
              ...
              <h4><font color="red">Update Profile</font></h4>
...
<form method="POST" enctype="multipart/form-data">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
   ...
   <!-- <th width="237" scope="row"><font color="#FFFFFF">Select Department</font></th> -->
      ...
      <th width="237" scope="row"><font color="red">Select Department</font></th>
...
<?php 	}
    ...
    <!-- <th width="237" scope="row"><font color="#FFFFFF">Semester Name</font> </th> -->
        ...
        <th width="237" scope="row"><font color="red">Semester Name</font> </th>
   ...
   <tr>
    ...
    <th width="237" scope="row"><font color="red">Teacher Name</font> </th>
   ...
   <tr>
    ...
    <th width="237" scope="row"><font color="red">Email</font> </th>
   ...
   <tr>
    <!-- <th width="237" scope="row"><font color="#FFFFFF">Password</font> </th> -->
        ...
        <th width="237" scope="row"><font color="red">Password</font> </th>
   ...
   <tr>
    <!-- <th width="237" scope="row"><font color="#FFFFFF">Mobile</font></th> -->
        ...
        <th width="237" scope="row"><font color="red">Mobile</font></th>
   ...
   <tr>
    ...
    <th width="237" scope="row"><font color="red">Address</font></th>
